...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand px-4 py-3 m-0"
                ...
                <img src="../../assets/img/profile.png" class="navbar-brand-img" width="24" height="24" alt="main_logo">
                <span class="ms-1 text-sm text-dark">PT Astra Komponen ID</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a href="#" class="btn bg-gradient-dark nav-link" data-bs-toggle="dropdown"
                ...
                <li class="nav-item dropdown mt-1">
                    <a href="#" class="btn nav-link text-dark" data-bs-toggle="dropdown" id="navbarDropdownMenuLink2">
                        <i class="material-symbols-rounded opacity-5">table_view</i>
                        <span class="nav-link-text ms-1">Dashboard</span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="../pages/billing.html">
                        ...
                        <span class="nav-link-text ms-1">uang</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        {{-- <nav
            class="navbar navbar-main navbar-expand-lg position-sticky top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex gap-2 align-items-center">
                        ...
                        <div class="input-group input-group-static my-3 mx-2">
                            <label>Date</label>
                            <input type="date" class="form-control">
                        </div>
                    </div>
                    <button class="nav-item mt-3 btn btn-outline-danger">Refresh</button>
